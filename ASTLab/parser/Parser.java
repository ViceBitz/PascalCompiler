 ...
 * Instead of immediately executing the statement, this Parser creates an abstract syntax tree, which is executed
 * altogether.
 * 
 * @author Victor Gong
 * @version 10/16/2023
...
public class Parser
{
    ...
    /**
     * Parses a factor ((), -, number)) and returns it as a new Expression object (Number, BinOp),

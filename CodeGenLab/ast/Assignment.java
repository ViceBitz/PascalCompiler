...
public class Assignment extends Statement
{
    ...
    /**
     * Compiles an assignment of a variable by first compiling the expression,
     * then emitting assembly code to save the value of the expression (in $v0)
     * to a label with the same name as the variable using the sw command
     * 
